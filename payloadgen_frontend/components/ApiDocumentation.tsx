...
// Import existing components (already created)
...
export default function DetailedDocumentation() {
  ...
  const CodeBox = ({ code, lang = "java" }: any) => (
    <pre className="bg-slate-950 p-4 rounded-lg overflow-x-auto border border-indigo-500/20 text-sm text-gray-300 my-3">
      <code>{code}</code>
    </pre>
  );

  const Step = ({ num, title, content }: any) => (
    <div className="mb-6 bg-slate-900/50 p-4 rounded-lg border-l-4 border-indigo-500">
      <div className="flex gap-3 items-start">
        <div className="bg-indigo-600 text-white rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 font-bold">
          {num}
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <Section id="overview" title="🎯 System Overview">
              <div className="space-y-4 text-gray-300">
                <p>
                  The PayloadGen system is built on a generic CRUD architecture
                  that allows you to perform Create, Read, Update, and Delete
                  operations on any entity without writing entity-specific code.
                </p>
                ...
                <div className="bg-indigo-900/20 border border-indigo-500/30 p-4 rounded-lg mt-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <p>
                      📌 DynamicCrudController - REST endpoints that receive API
                      requests
                    </p>
                    <p>
                      📌 GenericCrudService - Interface defining CRUD operations
                    </p>
                    <p>
                    ...
                    <p>
                      📌 EntityRegistry - Central registry of entities and their
                      repositories
                    </p>
                  </div>
                </div>
            ...
            <Section id="registration" title="🔐 Entity Registration System">
              <div className="space-y-4">
                ...
                <h4 className="font-bold text-indigo-400 mt-6 mb-3">
...
public class EntityRegistry {
        ...
        repositories.put(name.toLowerCase(), repository);
                ...
                <div className="bg-slate-900/50 p-4 rounded-lg border-l-4 border-cyan-500 mt-4">
                  ...
                  <p className="text-gray-300 text-sm">
                    entityClasses: user to User.class, product to Product.class
                  </p>
                  <p className="text-gray-300 text-sm">
    ...
    return bestMatch;
            ...
            <Section id="create" title="➕ Create/Update Request Flow">
              <div className="space-y-4">
                <h4 className="font-bold text-indigo-400 mb-3">
                  Request Journey:
                </h4>
    ...
    return entity;
            ...
            <Section id="diagram" title="📊 Complete Request Flow Diagram">
              <div className="space-y-6 text-sm text-gray-300">
                <div className="bg-slate-900/50 p-4 rounded border-l-4 border-indigo-500">
